...
import ag.ion.bion.officelayer.internal.application.LazyOpenOfficeApplicationInfo;
 ...
 */
public class ApplicationAssistant64Bit implements IApplicationAssistant {
     ...
     * @author Andreas Bröker
     */
    public ApplicationAssistant64Bit() throws OfficeApplicationException {
        this(null);
    }
     ...
     * @author Andreas Bröker
     */
    public ApplicationAssistant64Bit(String nativeLibPath)
     ...
     *
     * @deprecated As now also LibreOffice is supported, this method is only
     * keept for compatibility reasons and returns the same as null null null
     * null null     {@link #getLatestLocalOpenOfficeOrgApplication(IOfficeProgressMonitor)
         *             )}
     *
     * @author Markus Krüger
     * @date 07.07.2010
        ...
        for (majorVersion = 1; majorVersion < 10; majorVersion++) {
            for (minorVersion = 0; minorVersion < 10; minorVersion++) {
                for (updateVersion = 0; updateVersion < 10; updateVersion++) {
                    ...
                    //Nassif patch to find x86 apps from x64 JVM
                    arrayList.add("Applications\\Wow6432Node\\" + keyMainPart + " " + majorVersion + "." + minorVersion + "\\shell\\edit\\command");
                    arrayList.add("Applications\\Wow6432Node\\" + keyMainPart + " " + majorVersion + "." + minorVersion + "." + updateVersion + "\\shell\\edit\\command");
                    arrayList.add("Software\\Wow6432Node\\" + keyMainPart + "\\" + keyMainPart + "\\" + majorVersion + "." + minorVersion);
                    arrayList.add("Software\\Wow6432Node\\" + keyMainPart + "\\" + keyMainPart + "\\" + majorVersion + "." + minorVersion + "." + updateVersion);
                }
            }
        }
