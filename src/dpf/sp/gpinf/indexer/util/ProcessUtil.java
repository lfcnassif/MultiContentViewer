...
public class ProcessUtil {
    ...
    /*static interface Kernel32 extends Library {
     ...
     //WinNT.HANDLE handle = new WinNT.HANDLE(Pointer.createConstant(handLong));
     int pid = Kernel32.INSTANCE.GetProcessId(handLong);
	            
     // System.out.println(Kernel.INSTANCE.GetProcessId(handLong) + " - " + pid);
